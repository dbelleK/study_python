...
savename='D:/python_2022/data/forecast3.xml'
...
with open("D:/python_2022/data/cast3.txt", "wt",encoding="utf-8") as f:
    for data in soup.find_all("data"):
...
with open("D:/python_2022/data/forecast4.txt", "wt",encoding="utf-8") as f:
    f.write("지  역 : "+area+'\n')
    f.write("작성일자 : "+d+"\n\n")
    for data in soup.find_all("data"):
